# Wizard options: nerdfont-complete + powerline, small icons, classic, darkest, 2 lines,
# dotted, sparse, concise, transient_prompt, instant_prompt=verbose.
...
() {
  ...
  ################################[ user ]######################################################
  typeset -g POWERLEVEL9K_USER_FOREGROUND='#DFAD81'
  ...
  typeset -g POWERLEVEL9K_BATTERY_STAGES='123456789'
